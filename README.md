...
3. **Clone Repository**: `git clone https://github.com/tribhuwanpandey/retail-store-sample-app.git`
...
```sh
git clone https://github.com/tribhuwanpandey/retail-store-sample-app.git
```
